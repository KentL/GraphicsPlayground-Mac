...
#ifndef GRAPHICSPLAYGROUND_MAC_TEXTUREDPANEL_H
#define GRAPHICSPLAYGROUND_MAC_TEXTUREDPANEL_H
...
class TexturedPanel : public Renderable, public Node {
public:
    void Render();
...
#endif //GRAPHICSPLAYGROUND_MAC_TEXTUREDPANEL_H
