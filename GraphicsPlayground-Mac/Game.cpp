...
void Game::Init(int argc, char **argv) {
    ...
    switch (exampleIndex) {
        case 0:
            example = InterpolationExample::getInstance();
            break;
        case 1:
            example = RotateCubeExample::getInstance();
            break;
        case 2:
            example = RotateTextureCubeExample::getInstance();
            break;
        case 3:
            example = BlendExample::getInstance();
            break;
        case 4: {
        ...
        case 7:{
            CausticExample* causticExample = CausticExample::getInstance();
            causticExample->window = window;
